...
# ============================================================
# 1. モデル定義（CrossAttention + PositionalEncoding 追加版）
# ============================================================
...
class MusicToExpressionTransformer(nn.Module):
    def __init__(
        ...
        # Transformer Encoder（Self-Attention のみ・4層）
