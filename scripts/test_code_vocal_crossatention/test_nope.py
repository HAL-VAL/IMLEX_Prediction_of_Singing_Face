"""
=============================================================================
CrossAttention + VolStab モデル 推論スクリプト（PE なし）
=============================================================================
入力:
...
出力:
  - predictions/predictions_crossattn_volstab/{id}.pkl
      {
...
使い方:
  # 単一ファイル
  python test_crossattn_volstab.py --id id15_3_1_3

  # txtファイルで一括推論
  python test_crossattn_volstab.py --txt test.txt

  # チェックポイントを明示指定
  python test_crossattn_volstab.py --txt test.txt --checkpoint path/to/crossattn_volstab_best_model.pth
=============================================================================
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="CrossAttention + VolStab モデル 推論スクリプト（PE なし）"
    )
    ...
    output_dir = args.output_dir or os.path.join(
        dataset_base_dir, "predictions", "predictions_crossattn_volstab"
    )
