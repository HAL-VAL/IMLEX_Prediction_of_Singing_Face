"""
=============================================================================
CrossAttention + PositionalEncoding Model Inference Script
=============================================================================
Input:
...
Usage:
  # Single file
  python test_v2.py --id id15_3_1_3

  # Batch-infer all IDs listed in a txt file
  python test_v2.py --txt test.txt

  # Specify a checkpoint
  python test_v2.py --txt test.txt --checkpoint path/to/crossattn_pe_best_model.pth
=============================================================================
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="CrossAttention + PE Model Inference Script"
    )
