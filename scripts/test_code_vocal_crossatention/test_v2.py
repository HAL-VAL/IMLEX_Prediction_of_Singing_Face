"""
=============================================================================
CrossAttention + PositionalEncoding モデル 推論スクリプト
=============================================================================
入力:
...
出力:
  - predictions_crossattn_pe/{id}.pkl
      {
...
使い方:
  # 単一ファイル
  python test_crossattn_pe.py --id id15_3_1_3

  # txtファイルに書かれた全IDを一括推論
  python test_crossattn_pe.py --txt test.txt

  # チェックポイントを指定
  python test_crossattn_pe.py --txt test.txt --checkpoint path/to/crossattn_pe_best_model.pth
=============================================================================
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="CrossAttention + PE モデル 推論スクリプト"
    )
    ...
    if args.checkpoint:
        ...
        checkpoint_path = os.path.join(
            current_dir, "..", "..", "checkpoints", "crossattn_pe_best_model.pth"
        )
    ...
    output_dir = args.output_dir or os.path.join(
        dataset_base_dir, "predictions", "predictions_crossattn_pe"
    )
