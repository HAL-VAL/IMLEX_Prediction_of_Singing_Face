...
FEATURE_CACHE = "all_vocal_features_9feat_50d.pkl"
...
pval_df.to_csv(
    "vocal_vs_pca_pval_9feat_50d.csv"
)
...
summary_df.to_csv(
    "summary_metrics_9feat_50d_vocal.csv",
    index=False
)
...
plt.title(
    "Vocal – Expression Parameters (50D)"
)
...
plt.savefig(
    os.path.join("pca_figures", "vocal_vs_pca_heatmap_9feat_50d.png"),
    dpi=300
)
